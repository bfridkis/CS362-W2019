/* Class to provide reference data from DomainValidator.java 
 * All private members have been copied directly from DomainValidator.java */

import java.util.Arrays;

public class DomainValidatorReference {
...
//        "tp",                 // East Timor (Retired)
    ...
    //Get methods for returning private member data...
    
    //Return Max Domain Length
    public static int getMaxDomainLength() {
    	return MAX_DOMAIN_LENGTH;
    }
    
    //Return Infrastructure TLDS @ index
    public static String getInfrastructureTLDS(int index) {
    	return INFRASTRUCTURE_TLDS[index];
    }
    
    //Return length of Infrastructure TDLS String array
    public static int getInfrastructureTLDSLength() {
    	return INFRASTRUCTURE_TLDS.length;
    }
    
    //Return Generic TLDS @ index
    public static String getGenericTLDS(int index) {
    	return GENERIC_TLDS[index];
    }
    
    public static int getGenericTLDSLength() {
    	return GENERIC_TLDS.length;
    }
    
    //Return Country_Code TLDS @ index
    public static String getCountryCodeTLDS(int index) {
    	return COUNTRY_CODE_TLDS[index];
    }
    
    public static int getCountryCodeTLDSLength() {
    	return COUNTRY_CODE_TLDS.length;
    }
    
    //Return Local TLDS @ index
    public static String getLocalTLDS(int index) {
    	return LOCAL_TLDS[index];
    }
    
    public static int getLocalTLDSLength() {
    	return LOCAL_TLDS.length;
    }
}
